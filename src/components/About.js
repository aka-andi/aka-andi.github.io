         ...
         <section id="about">
            <div className="text">
               ...
               <span><p>
                  ...
                  <h3>mentions:</h3>
                  <ul>
                     <li><a href="https://cahmp.gmu.edu/2022-cahmp-entrepreneurship-challenge/">center for the advancement of human-machine partnership ⁺₊ entrepreneurship challenge 2022</a></li>
